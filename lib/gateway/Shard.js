  ...
  wsEvent(packet) {
    switch (packet.t) {
      ...
      case "SUBSCRIPTION_CREATE ": {
        /**
         * Fired when an subscription is created
         * @event Client#subscriptionCreate
         * @prop {Subscription} subscription The new subscription
         */
        this.emit("subscriptionCreate", new Subscription(packet.d));
        break;
      }
      case "SUBSCRIPTION_UPDATE": {
        /**
         * Fired when an subscription is updated
         * @event Client#subscriptionUpdate
         * @prop {Subscription} subscription The updated subscription
         */
        this.emit("subscriptionUpdate", new Subscription(packet.d));
        break;
      }
      case "SUBSCRIPTION_DELETE": {
        /**
         * Fired when an subscription is deleted
         * @event Client#subscriptionDelete
         * @prop {Subscription} subscription The deleted subscription
         */
        this.emit("subscriptionDelete", new Subscription(packet.d));
        break;
      }
      default: {
        /**
