 ...
 * @prop {Object?} recurrenceRule The [definitions](https://discord.dev/resources/guild-scheduled-event#guild-scheduled-event-recurrence-rule-object) for how often this event should recur. Note: properties have been camelCased, and ISO8601 timestamps are represented by epoch number.
    ...
    if (data.recurrence_rule !== undefined) {
      if (data.recurrence_rule === null) {
        ...
        this.recurrenceRule = {
          ...
          end: data.recurrence_rule.end && Date.parse(data.recurrence_rule.end),
