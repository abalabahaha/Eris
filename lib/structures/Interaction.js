...
const { InteractionTypes, ApplicationCommandIntegrationTypes } = require("../Constants");
 ...
 * @prop {object} authorizingIntegrationOwners An object containing the values IDs of the user and/or guild that authorized the app. guildInstall for GuildID and userInstall for UserID
...
class Interaction extends Base {
  constructor(data, client) {
    super(data.id);
    console.log(data) // TODO: REMOVE CONSOLE LOG DEBUG
    this._client = client;

    this.applicationID = data.application_id;
    this.authorizingIntegrationOwners = {
      userInstall: data.authorizing_integration_owners[ApplicationCommandIntegrationTypes.USER_INSTALL],
      guildInstall: data.authorizing_integration_owners[ApplicationCommandIntegrationTypes.GUILD_INSTALL]
    };
